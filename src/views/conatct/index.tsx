...
export const ContactView = ({ setOpenContact }) => {
  const [state, handleSubmit] = useForm('xzbngwel');
  if (state.succeeded) {
    notify({
      type: 'success',
      message: 'Thanks for summittung your message, will get back to you',
    });
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className='mb-4'>
                      ...
                      <input
                        ...
                        id='email'
                        name='email'
                        className='border-default-200 block w-full rounded border-white/10 bg-transparent py-1.5 px-3
                          text-white/80 focus:border-white/25 focus:ring-transparent'
                        placeholder='email'
                      />
                    </div>
                    <ValidationError
                    ...
                    <textarea
                      ...
                      id='message'
                      rows={6}
                      className='border-default-200 relative block w-full rounded border-white/10 bg-transparent py-1.5 px-3
                          text-white/80 focus:border-white/25 focus:ring-transparent'
                      placeholder='message'
                    ></textarea>
                    <ValidationError
