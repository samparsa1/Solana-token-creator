        ...
        <div className='mb-10 flex items-end justify-between'>
          <div className='mx-auto max-w-2xl text-center'>
            ...
            <p className='text-default-200 text-sm font-medium'>
              ...
              Inventore libero in placeat sed doloribus eligendi obcaecati,
              earum eos corporis voluptatem.
            </p>
          </div>
        </div>
        ...
        <div className='mx-auto max-w-3xl'>
          <div className='hs-accordion-group space-y-4'>
            {question.map((question, index) => (
              <div
                key={index}
                className={`hs-accordion bg-default-950/40
              overflow-hidden rounded-lg border border-white/10 backdrop-blur-3xl`}
                id={question.id}
              >
                <button
                  className='hs-accordion-toggle inline-flex items-center 
                justy-between 
                gap-x-3 px-6 py-4 text-left capitalize
