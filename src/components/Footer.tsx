  ...
  return (
    <footer className='bg-default-950/40 backdrop-blur-3xl'>
              ...
              <div className='p-10'>
                ...
                <form onSubmit={handleSubmit} className='mb-6 space-y-2'>
                  ...
                  <div className='relative'>
                    ...
                    border-primary 
                    bg-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 
                    rounded-md px-6 text-white transition-all'
                    >
                      Subscribe
                    </button>
                  </div>
                ...
                <div>
                  <h6 className='mb-4 text-base trext-white'>Follow Us</h6>
      ...
      <div className='border-t border-white/10 py-6'>
        <div
          className='md:text-start container flex h-full flex-wrap items-center justify-center gap-4 text-center
