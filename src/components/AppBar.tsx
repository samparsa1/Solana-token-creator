          ...
          <div className='container'>
            <nav>
              ...
              <div className='ms-auto flex items-center px-2.5 lg:hidden'>
                <button className='hs-collapse-toggle bg-default-100/5 
              ...
              <div className='hs-collapse mx-auto mt-2 hidden grow basis-full items-center 
              justify-center transition-all duration-300 lg:mt-0 lg:flex lg:basis-auto'
              id='mobileMenu'>
