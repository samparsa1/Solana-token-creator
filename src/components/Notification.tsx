...
const NotificationList = () => {
  ...
  return (
    <div className={`pointer-events-none fixed insect-0 z-20 flex items-end px-4 py-6 sm:p-6`}>
            ...
            <div className='text-fgd-1 font-bold'>{message}</div>
            {
              ...
              txid ? (
                <div className='flex flex-row'>
                  <a href={`https://explorer.solana.com/tx/` + txid + `?cluster${networkConfiguration}`} target="_blank" 
                  rel="noreferrer"
